    ...
    return (
        <Drawer.Root open={open} onOpenChange={onOpenChange} shouldScaleBackground>
            ...
            <Drawer.Portal>
                ...
                <Drawer.Content
                    className={cn(
                        "bg-white dark:bg-gray-900 flex flex-col rounded-t-[20px] h-[96%] mt-24 fixed bottom-0 left-0 right-0 z-[9999] focus:outline-none border-t border-gray-200 dark:border-gray-800 md:max-w-md md:mx-auto",
                        className
                    )}
                >
