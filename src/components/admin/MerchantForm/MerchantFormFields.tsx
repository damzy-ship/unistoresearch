...
import BillingDateManager from '../MerchantEdit/BillingDateManager';
...
/**
 * Form fields component for merchant registration
 * Handles basic merchant information input
 */
export default function MerchantFormFields({ 
  merchantForm, 
  setMerchantForm, 
  schools 
