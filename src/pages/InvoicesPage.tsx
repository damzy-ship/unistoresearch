                ...
                <main className="bg-white rounded-2xl shadow-lg p-4 sm:p-6">
                    <div className="border-b border-gray-200 pb-4 mb-4">
                        ...
                        <div className="flex justify-between items-center mt-2 text-sm">
                            <p className="text-gray-600">Total Income: <span className="font-semibold text-green-600">{formatAmount(totalPaid)}</span></p>
                            <p className="text-gray-600">Total Collected: <span className="font-semibold text-yellow-600">{formatAmount(totalCollected)}</span></p>
                        </div>
                    </div>
                                ...
                                <div key={monthYear}>
                                    ...
                                    <ul className="space-y-3">
                                        {invoices.map((inv, idx) => {
                                            ...
                                            return (
                                                <li onClick={() => { setSelectedInvoice(inv); }} key={`${inv.customer_id}-${inv.created_at}-${idx}`} className="cursor-pointer p-3 bg-gray-50 border border-gray-200 rounded-xl flex items-center space-x-4">
