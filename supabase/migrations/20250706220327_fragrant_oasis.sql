/*
  ...
  1. New Table
    - `site_reviews` - Store user reviews of the site/platform
      - `id` (uuid, primary key)
...
-- Create site_reviews table if it doesn't exist
...
-- Add indexes for better performance (these are idempotent)
