-- Clean up invalid merchant_id values and fix relationship
-- First, delete any real_time_products with invalid merchant_id
...
-- Now ensure merchant_id is UUID type
